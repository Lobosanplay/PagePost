      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-white dark:border-gray-600 shadow-lg p-6 mb-12">
          ...
          <div className="space-y-4">
            ...
            <button
              onClick={createPost}
              className="w-full px-4 py-2 font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors font-semibold"
            >
              Publicar Post
            </button>
          </div>
